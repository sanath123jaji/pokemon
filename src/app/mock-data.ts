export const getPokemonByIdMockData =  {
    id: 1,
    name: 'Bulbasaur',
    sprites : {
...
export const getPokemonsMockData = {
    count: 2,
      next:'',
      previous:'',
      results: [
...
export const getPokemonEvolutionChainMockData = {
...
export const getPokemonSpeciesMockData = {
    "base_happiness": 50,
    "capture_rate": 45,
    "color": {
        "name": "green",
